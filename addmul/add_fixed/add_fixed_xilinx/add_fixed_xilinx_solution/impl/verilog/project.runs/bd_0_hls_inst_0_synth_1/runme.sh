...
HD_PWD='/home/nghielme/PycharmProjects/thesis-project/addmul/add_fixed/add_fixed_xilinx/add_fixed_xilinx_solution/impl/verilog/project.runs/bd_0_hls_inst_0_synth_1'
cd "$HD_PWD"
