...
HLS_SOURCES = ../../../../add_fixed_test.cpp ../../../../add_fixed.cpp
...
$(ObjDir)/add_fixed_test.o: ../../../../add_fixed_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../add_fixed_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/add_fixed_test.d

$(ObjDir)/add_fixed.o: ../../../../add_fixed.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../add_fixed.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I../../../../../ac_types/include -O2 -D__BAMBU__ -D__VIVADO__ -DAC_TYPES_INIT -std=c++14  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/add_fixed.d
