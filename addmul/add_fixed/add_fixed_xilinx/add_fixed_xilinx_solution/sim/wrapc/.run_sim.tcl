...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "add_fixed_top.autotvin.dat"
	set constFileTvOut       "add_fixed_top.autotvout.dat"
	set constFileHdlTvIn     "add_fixed_top.autohdltvin.dat"
	set constFileHdlTvOut    "add_fixed_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
