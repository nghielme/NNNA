...
if {[file isfile add_fixed_top.autotvin.dat]} {
	file delete -force add_fixed_top.autotvin.dat
}

if {[file isfile add_fixed_top.autotvout.dat]} {
	file delete -force add_fixed_top.autotvout.dat
}
