...
HD_PWD='/home/nghielme/PycharmProjects/thesis-project/addmul/mul_float/mul_float_xilinx/mul_float_xilinx_solution/impl/verilog/project.runs/bd_0_hls_inst_0_synth_1'
cd "$HD_PWD"
