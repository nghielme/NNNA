...
HLS_SOURCES = ../../../../mul_float_test.cpp ../../../../mul_float.cpp
...
$(ObjDir)/mul_float_test.o: ../../../../mul_float_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../mul_float_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/mul_float_test.d

$(ObjDir)/mul_float.o: ../../../../mul_float.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../mul_float.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I../../../../../ac_types/include -O2 -D__BAMBU__ -D__VIVADO__ -DAC_TYPES_INIT -std=c++14  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mul_float.d
