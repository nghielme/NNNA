; ModuleID = '/home/nghielme/PycharmProjects/thesis-project/addmul/mul_float/mul_float_xilinx/mul_float_xilinx_solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_mul_float_top_hw(i128* %a_copy, i128* %b_copy, i128* %res_copy)
...
declare void @apatb_mul_float_top_hw(i128*, i128*, i128*)
...
define void @mul_float_top_hw_stub_wrapper(i128*, i128*, i128*) #4 {
entry:
  ...
  call void @mul_float_top_hw_stub(%"class.ac_float<25, 2, 8, AC_TRN>"* %3, %"class.ac_float<25, 2, 8, AC_TRN>"* %4, %"class.ac_float<25, 2, 8, AC_TRN>"* %5)
...
declare void @mul_float_top_hw_stub(%"class.ac_float<25, 2, 8, AC_TRN>"*, %"class.ac_float<25, 2, 8, AC_TRN>"*, %"class.ac_float<25, 2, 8, AC_TRN>"*)
