...
if {[file isfile mul_float_top.autotvin.dat]} {
	file delete -force mul_float_top.autotvin.dat
}

if {[file isfile mul_float_top.autotvout.dat]} {
	file delete -force mul_float_top.autotvout.dat
}
