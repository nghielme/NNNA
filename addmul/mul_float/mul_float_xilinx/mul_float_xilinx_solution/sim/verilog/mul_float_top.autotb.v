...
`define AUTOTB_DUT      mul_float_top
`define AUTOTB_DUT_INST AESL_inst_mul_float_top
`define AUTOTB_TOP      apatb_mul_float_top_top
`define AUTOTB_LAT_RESULT_FILE "mul_float_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mul_float_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mul_float_top_top
...
`define AUTOTB_TVIN_a  "../tv/cdatafile/c.mul_float_top.autotvin_a.dat"
`define AUTOTB_TVIN_b  "../tv/cdatafile/c.mul_float_top.autotvin_b.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.mul_float_top.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.mul_float_top.autotvin_b.dat"
`define AUTOTB_TVOUT_res  "../tv/cdatafile/c.mul_float_top.autotvout_res.dat"
`define AUTOTB_TVOUT_res_out_wrapc  "../tv/rtldatafile/rtl.mul_float_top.autotvout_res.dat"
module `AUTOTB_TOP;
