...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mul_float_top.autotvin.dat"
	set constFileTvOut       "mul_float_top.autotvout.dat"
	set constFileHdlTvIn     "mul_float_top.autohdltvin.dat"
	set constFileHdlTvOut    "mul_float_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
