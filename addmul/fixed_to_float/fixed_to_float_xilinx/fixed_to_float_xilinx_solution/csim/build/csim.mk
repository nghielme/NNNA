...
HLS_SOURCES = ../../../../fixed_to_float_test.cpp ../../../../fixed_to_float.cpp
...
$(ObjDir)/fixed_to_float_test.o: ../../../../fixed_to_float_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../fixed_to_float_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/fixed_to_float_test.d

$(ObjDir)/fixed_to_float.o: ../../../../fixed_to_float.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../fixed_to_float.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I../../../../../ac_types/include -O2 -D__BAMBU__ -D__VIVADO__ -DAC_TYPES_INIT -std=c++14  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fixed_to_float.d
