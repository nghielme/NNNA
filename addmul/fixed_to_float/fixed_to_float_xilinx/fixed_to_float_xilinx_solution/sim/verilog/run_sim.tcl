...
if {[file isfile fixed_to_float_top.autotvin.dat]} {
	file delete -force fixed_to_float_top.autotvin.dat
}

if {[file isfile fixed_to_float_top.autotvout.dat]} {
	file delete -force fixed_to_float_top.autotvout.dat
}
