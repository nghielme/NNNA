...
#define AUTOTB_TVOUT_fixpo "../tv/cdatafile/c.fixed_to_float_top.autotvout_fixpo.dat"
#define AUTOTB_TVIN_flopo "../tv/cdatafile/c.fixed_to_float_top.autotvin_flopo.dat"
#define AUTOTB_TVOUT_flopo "../tv/cdatafile/c.fixed_to_float_top.autotvout_flopo.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_flopo "../tv/rtldatafile/rtl.fixed_to_float_top.autotvout_flopo.dat"
...
extern "C"
void fixed_to_float_top_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_fixed_to_float_top_hw(void* __xlx_apatb_param_fixpo, void* __xlx_apatb_param_flopo)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_fixpo),
#endif
  };
  port0.param = __xlx_apatb_param_fixpo;

  static hls::sim::Register port1 {
    .name = "flopo",
    .width = 128,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_flopo),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_flopo),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_flopo),
#endif
  };
  port1.param = __xlx_apatb_param_flopo;
  ...
  try {
    ...
    fixed_to_float_top_hw_stub_wrapper(__xlx_apatb_param_fixpo, __xlx_apatb_param_flopo);
