...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fixed_to_float_top.autotvin.dat"
	set constFileTvOut       "fixed_to_float_top.autotvout.dat"
	set constFileHdlTvIn     "fixed_to_float_top.autohdltvin.dat"
	set constFileHdlTvOut    "fixed_to_float_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
