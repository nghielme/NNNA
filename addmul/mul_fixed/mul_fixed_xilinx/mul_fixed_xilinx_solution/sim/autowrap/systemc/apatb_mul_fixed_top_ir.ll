; ModuleID = '/home/nghielme/PycharmProjects/thesis-project/addmul/mul_fixed/mul_fixed_xilinx/mul_fixed_xilinx_solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mul_fixed_top_ir(%"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* noalias nocapture nonnull readonly dereferenceable(40) %a, %"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* noalias nocapture nonnull readonly dereferenceable(40) %b, %"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* noalias nocapture nonnull dereferenceable(40) %res) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mul_fixed_top_hw(i320* %a_copy, i320* %b_copy, i320* %res_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>.12"(%"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* %0, i320* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>.12"(%"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* %2, i320* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>.12"(%"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* %4, i320* align 512 %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>.12"(%"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* noalias, i320* noalias readonly align 512) unnamed_addr #3 {
entry:
...
declare void @apatb_mul_fixed_top_hw(i320*, i320*, i320*)
...
define void @mul_fixed_top_hw_stub_wrapper(i320*, i320*, i320*) #4 {
entry:
  ...
  call void @mul_fixed_top_hw_stub(%"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* %3, %"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* %4, %"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"* %5)
...
declare void @mul_fixed_top_hw_stub(%"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"*, %"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"*, %"class.ac_fixed<281, 127, true, AC_TRN, AC_WRAP>"*)
