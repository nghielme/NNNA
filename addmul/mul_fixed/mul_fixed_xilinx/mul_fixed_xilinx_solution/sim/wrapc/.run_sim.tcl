...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mul_fixed_top.autotvin.dat"
	set constFileTvOut       "mul_fixed_top.autotvout.dat"
	set constFileHdlTvIn     "mul_fixed_top.autohdltvin.dat"
	set constFileHdlTvOut    "mul_fixed_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
