...
if {[file isfile mul_fixed_top.autotvin.dat]} {
	file delete -force mul_fixed_top.autotvin.dat
}

if {[file isfile mul_fixed_top.autotvout.dat]} {
	file delete -force mul_fixed_top.autotvout.dat
}
