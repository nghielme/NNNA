...
HD_PWD='/home/nghielme/PycharmProjects/thesis-project/addmul/mul_fixed/mul_fixed_xilinx/mul_fixed_xilinx_solution/impl/verilog/project.runs/bd_0_hls_inst_0_synth_1'
cd "$HD_PWD"
