...
HLS_SOURCES = ../../../../mul_fixed_test.cpp ../../../../mul_fixed.cpp
...
$(ObjDir)/mul_fixed_test.o: ../../../../mul_fixed_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../mul_fixed_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/mul_fixed_test.d

$(ObjDir)/mul_fixed.o: ../../../../mul_fixed.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../mul_fixed.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I../../../../../ac_types/include -O2 -D__BAMBU__ -D__VIVADO__ -DAC_TYPES_INIT -std=c++14  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mul_fixed.d
