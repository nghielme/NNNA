...
HLS_SOURCES = ../../../../add_float_test.cpp ../../../../add_float.cpp
...
$(ObjDir)/add_float_test.o: ../../../../add_float_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../add_float_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/add_float_test.d

$(ObjDir)/add_float.o: ../../../../add_float.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../add_float.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I../../../../../ac_types/include -O2 -D__BAMBU__ -D__VIVADO__ -DAC_TYPES_INIT -std=c++14  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/add_float.d
