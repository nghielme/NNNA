...
set ip_vlnv xilinx.com:hls:add_float_top:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project add_float_xilinx
dict set report_options hls_solution add_float_xilinx_solution
...
dict set report_options bindmodules {add_float_top_flow_control_loop_pipe_sequential_init add_float_top_adjust_9_s_tab_ROM_AUTO_1R}
