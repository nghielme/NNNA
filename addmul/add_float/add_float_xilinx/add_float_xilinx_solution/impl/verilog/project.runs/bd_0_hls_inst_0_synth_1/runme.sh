...
HD_PWD='/home/nghielme/PycharmProjects/thesis-project/addmul/add_float/add_float_xilinx/add_float_xilinx_solution/impl/verilog/project.runs/bd_0_hls_inst_0_synth_1'
cd "$HD_PWD"
