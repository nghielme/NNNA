...
(* CORE_GENERATION_INFO="add_float_top_add_float_top,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=50.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=33.828375,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=465,HLS_SYN_LUT=3581,HLS_VERSION=2022_2}" *)

module add_float_top (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
add_float_top_plus_minus_25_2_8_0_25_2_8_0_s grp_plus_minus_25_2_8_0_25_2_8_0_s_fu_49(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
