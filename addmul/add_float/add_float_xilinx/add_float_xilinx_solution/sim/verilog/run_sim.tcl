...
if {[file isfile add_float_top.autotvin.dat]} {
	file delete -force add_float_top.autotvin.dat
}

if {[file isfile add_float_top.autotvout.dat]} {
	file delete -force add_float_top.autotvout.dat
}
