...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "add_float_top.autotvin.dat"
	set constFileTvOut       "add_float_top.autotvout.dat"
	set constFileHdlTvIn     "add_float_top.autohdltvin.dat"
	set constFileHdlTvOut    "add_float_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
