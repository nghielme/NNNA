proc dump_statistics {  } {
  ...
  file delete -force /home/nghielme/PycharmProjects/thesis-project/addmul/add_float/HLS_output//Synthesis/vivado_flow/add_float_top_report.xml 
  set ofile_report [open /home/nghielme/PycharmProjects/thesis-project/addmul/add_float/HLS_output//Synthesis/vivado_flow/add_float_top_report.xml w]
...
set outputDir /home/nghielme/PycharmProjects/thesis-project/addmul/add_float/HLS_output//Synthesis/vivado_flow
file mkdir $outputDir
create_project add_float_top -part xc7z020clg484-1 -force
read_verilog /home/nghielme/PycharmProjects/thesis-project/addmul/add_float/add_float_top.v
set rfile_sdc [open /home/nghielme/PycharmProjects/thesis-project/addmul/add_float/HLS_output//Synthesis/vivado_flow/add_float_top.sdc r]
set clk_constraint [regexp -all --  CLK_SRC [read $rfile_sdc [file size /home/nghielme/PycharmProjects/thesis-project/addmul/add_float/HLS_output//Synthesis/vivado_flow/add_float_top.sdc]]]
if { [expr {$clk_constraint == 0}] } {
  set ofile_sdc [open /home/nghielme/PycharmProjects/thesis-project/addmul/add_float/HLS_output//Synthesis/vivado_flow/add_float_top.sdc a]
  puts $ofile_sdc "set_property HD.CLK_SRC BUFGCTRL_X0Y0 \[get_ports clock\]"
  close $ofile_sdc
}
read_xdc /home/nghielme/PycharmProjects/thesis-project/addmul/add_float/HLS_output//Synthesis/vivado_flow/add_float_top.sdc
synth_design -mode out_of_context -no_iobuf -top add_float_top -part xc7z020clg484-1
