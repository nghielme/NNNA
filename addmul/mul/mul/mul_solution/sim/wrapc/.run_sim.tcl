...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mul_top.autotvin.dat"
	set constFileTvOut       "mul_top.autotvout.dat"
	set constFileHdlTvIn     "mul_top.autohdltvin.dat"
	set constFileHdlTvOut    "mul_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
