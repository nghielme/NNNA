; ModuleID = '/home/nghielme/PycharmProjects/thesis-project/addmul/mul/mul/mul_solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mul_top_ir(%"class.ac_float<25, 2, 8, AC_TRN>"* noalias nocapture nonnull readonly dereferenceable(16) %a, %"class.ac_float<25, 2, 8, AC_TRN>"* noalias nocapture nonnull readonly dereferenceable(16) %b, %"class.ac_float<25, 2, 8, AC_TRN>"* noalias nocapture nonnull dereferenceable(16) %res) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mul_top_hw(i128* %a_copy, i128* %b_copy, i128* %res_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.154"(%"class.ac_float<25, 2, 8, AC_TRN>"* %0, i128* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.154"(%"class.ac_float<25, 2, 8, AC_TRN>"* %2, i128* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.154"(%"class.ac_float<25, 2, 8, AC_TRN>"* %4, i128* align 512 %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.154"(%"class.ac_float<25, 2, 8, AC_TRN>"* noalias, i128* noalias readonly align 512) unnamed_addr #3 {
entry:
...
declare void @apatb_mul_top_hw(i128*, i128*, i128*)
...
define void @mul_top_hw_stub_wrapper(i128*, i128*, i128*) #4 {
entry:
  ...
  call void @mul_top_hw_stub(%"class.ac_float<25, 2, 8, AC_TRN>"* %3, %"class.ac_float<25, 2, 8, AC_TRN>"* %4, %"class.ac_float<25, 2, 8, AC_TRN>"* %5)
...
declare void @mul_top_hw_stub(%"class.ac_float<25, 2, 8, AC_TRN>"*, %"class.ac_float<25, 2, 8, AC_TRN>"*, %"class.ac_float<25, 2, 8, AC_TRN>"*)
