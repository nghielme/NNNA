...
define void @apatb_mul_top_ir(%"class.ac_float<25, 2, 8, AC_TRN>"* %a, %"class.ac_float<25, 2, 8, AC_TRN>"* %b, %"class.ac_float<25, 2, 8, AC_TRN>"* %res) local_unnamed_addr #0 {
entry:
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.132"(%"class.ac_float<25, 2, 8, AC_TRN>"* %0, i128* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.132"(%"class.ac_float<25, 2, 8, AC_TRN>"* %2, i128* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.132"(%"class.ac_float<25, 2, 8, AC_TRN>"* %4, i128* align 512 %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.132"(%"class.ac_float<25, 2, 8, AC_TRN>"* noalias, i128* noalias readonly align 512) unnamed_addr #3 {
entry:
