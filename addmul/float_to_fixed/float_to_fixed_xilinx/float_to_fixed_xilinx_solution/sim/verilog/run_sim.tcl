...
if {[file isfile float_to_fixed_top.autotvin.dat]} {
	file delete -force float_to_fixed_top.autotvin.dat
}

if {[file isfile float_to_fixed_top.autotvout.dat]} {
	file delete -force float_to_fixed_top.autotvout.dat
}
