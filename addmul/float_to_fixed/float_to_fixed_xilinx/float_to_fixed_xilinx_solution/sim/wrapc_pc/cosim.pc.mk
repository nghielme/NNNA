...
$(ObjDir)/float_to_fixed_test.cpp_pre.cpp.tb.o : float_to_fixed_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling float_to_fixed_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/float_to_fixed.cpp_pre.cpp.tb.o : float_to_fixed.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling float_to_fixed.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
