; ModuleID = '/home/nghielme/PycharmProjects/thesis-project/addmul/float_to_fixed/float_to_fixed_xilinx/float_to_fixed_xilinx_solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_float_to_fixed_top_ir(%"class.ac_float<25, 2, 8, AC_TRN>"* %flopo, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* %fixpo) local_unnamed_addr #0 {
entry:
  %flopo_copy = alloca i128, align 512
  %fixpo_copy = alloca i64, align 512
  call fastcc void @copy_in(%"class.ac_float<25, 2, 8, AC_TRN>"* %flopo, i128* nonnull align 512 %flopo_copy, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* %fixpo, i64* nonnull align 512 %fixpo_copy)
  call void @apatb_float_to_fixed_top_hw(i128* %flopo_copy, i64* %fixpo_copy)
  call fastcc void @copy_out(%"class.ac_float<25, 2, 8, AC_TRN>"* %flopo, i128* nonnull align 512 %flopo_copy, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* %fixpo, i64* nonnull align 512 %fixpo_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_in(%"class.ac_float<25, 2, 8, AC_TRN>"* readonly, i128* noalias align 512, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* readonly, i64* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.21"(i128* align 512 %1, %"class.ac_float<25, 2, 8, AC_TRN>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"(i64* align 512 %3, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* %2)
  ret void
}
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %17 = and i128 %5, %16
  %18 = lshr i128 %17, %9
  %.partselect = trunc i128 %18 to i8
...
copy.split:                                       ; preds = %for.loop
  ...
  %20 = lshr i128 %19, 64
  %.partselect3 = trunc i128 %20 to i32
  store i32 %.partselect3, i32* %.12.0.0.0.024, align 8
  br label %for.loop4
...
for.loop4:                                        ; preds = %for.loop4, %copy.split
  ...
  %.end1 = add nuw nsw i64 %21, 103
  %23 = zext i64 %22 to i128
  %24 = zext i64 %.end1 to i128
  ...
  %31 = and i128 %5, %30
  %32 = lshr i128 %31, %23
  %.partselect2 = trunc i128 %32 to i8
  store i8 %.partselect2, i8* %dst.addr727, align 1
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"(i64* noalias align 512, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* noalias readonly) unnamed_addr #2 {
entry:
  %2 = icmp eq i64* %0, null
  %3 = icmp eq %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out(%"class.ac_float<25, 2, 8, AC_TRN>"*, i128* noalias readonly align 512, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"*, i64* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>"(%"class.ac_float<25, 2, 8, AC_TRN>"* %0, i128* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>.14"(%"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* %2, i64* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>.14"(%"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* noalias, i64* noalias readonly align 512) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  ...
  store i64 %5, i64* %.01.0.05, align 512
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0class.ac_float<25, 2, 8, AC_TRN>.21"(i128* noalias align 512, %"class.ac_float<25, 2, 8, AC_TRN>"* noalias readonly) unnamed_addr #2 {
entry:
...
declare void @apatb_float_to_fixed_top_hw(i128*, i64*)

define void @float_to_fixed_top_hw_stub_wrapper(i128*, i64*) #4 {
entry:
  %2 = alloca %"class.ac_float<25, 2, 8, AC_TRN>"
  %3 = alloca %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"
  call void @copy_out(%"class.ac_float<25, 2, 8, AC_TRN>"* %2, i128* %0, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* %3, i64* %1)
  call void @float_to_fixed_top_hw_stub(%"class.ac_float<25, 2, 8, AC_TRN>"* %2, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* %3)
  call void @copy_in(%"class.ac_float<25, 2, 8, AC_TRN>"* %2, i128* %0, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"* %3, i64* %1)
  ret void
}

declare void @float_to_fixed_top_hw_stub(%"class.ac_float<25, 2, 8, AC_TRN>"*, %"class.ac_fixed<64, 32, true, AC_TRN, AC_WRAP>"*)
