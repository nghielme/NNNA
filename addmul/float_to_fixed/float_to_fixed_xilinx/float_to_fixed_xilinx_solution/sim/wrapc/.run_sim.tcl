...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "float_to_fixed_top.autotvin.dat"
	set constFileTvOut       "float_to_fixed_top.autotvout.dat"
	set constFileHdlTvIn     "float_to_fixed_top.autohdltvin.dat"
	set constFileHdlTvOut    "float_to_fixed_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
