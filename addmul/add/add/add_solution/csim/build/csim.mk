...
$(ObjDir)/add_test.o: ../../../../add_test.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I../../../../../ac_types/include -O2 -D__BAMBU__ -D__VIVADO__ -std=c++14 -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/add_test.d

$(ObjDir)/add.o: ../../../../add.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../add.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I../../../../../ac_types/include -O2 -D__BAMBU__ -D__VIVADO__ -std=c++14  $(IFLAG) $(DFLAG) $< -o $@ ; \
