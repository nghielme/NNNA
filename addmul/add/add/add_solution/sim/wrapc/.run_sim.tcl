...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "add_top.autotvin.dat"
	set constFileTvOut       "add_top.autotvout.dat"
	set constFileHdlTvIn     "add_top.autohdltvin.dat"
	set constFileHdlTvOut    "add_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
