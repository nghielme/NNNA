...
architecture behav of add_top_adjust_9_s is 
...
attribute shreg_extract : string;
    ...
    component add_top_adjust_9_Pipeline_VITIS_LOOP_2139_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component add_top_adjust_9_s_tab_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
...
begin
    tab_U : component add_top_adjust_9_s_tab_ROM_AUTO_1R
    generic map (
        DataWidth => 3,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    grp_adjust_9_Pipeline_VITIS_LOOP_2139_1_fu_186 : component add_top_adjust_9_Pipeline_VITIS_LOOP_2139_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
